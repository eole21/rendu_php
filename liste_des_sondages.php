...
<body>
    ...
    <main>
        ...
        <?php  $sondage= $db -> query("SELECT * FROM sondage;");  ?>
        <!--selection de tous les élément de la table sondage-->
        <section id="tb1">
            <table id="tb">
                <!-- tableau d'affichage de la liste dessondages-->
                <thead>
                    <!--en tête du tableau-->
                    <tr>
                        <th class="th">ID</th>
                ...
                <tbody>
                    <?php foreach ($sondage as $sondages) : ?>
                    <!--élément du tableau// boucle foreach pour parcourir tous les éléments du
                 tableau-->
                    <tr>
                    ...
                    <?php endforeach; ?>
                    <!--Arrêt de la boucle foreach parce que j'ai utilisé sa syntaxe alternative qui s'écrit avec des 
             acolades-->
                </tbody>
            </table>
        </section>
